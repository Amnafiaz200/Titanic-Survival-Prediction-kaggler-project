Original file is located at
    https://colab.research.google.com/drive/1NoOXeaZcJOwc1UfuBS5oXNJLR5Jkf3aK

# Titanic Survival Prediction — Custom Decision Tree and Random Forest

In this project, I build two models **from scratch** (without using scikit-learn classifiers):

1. **Part 1 — Custom Decision Tree**
2. **Part 2 — Custom Random Forest**
2. **Part 3 — SVM**

I will train them on the **Titanic dataset** to predict passenger survival.  
I also analyze model accuracy and compare results.
