**Titanic Survival Prediction — Custom Decision Tree, Random Forest & SVM**
**Description**
...
**Custom Random Forest**: Ensemble of decision trees to improve accuracy.
**SVM Classifier**: Comparison using Support Vector Machine.

**Dataset**
Uses the Titanic dataset, containing passenger information such as age, sex, class, and survival status.

**Installation**
Clone the repository:
git clone https://github.com/Amnafiaz200/titanic-survival-prediction.git

**Contributing**
Contributions are welcome! Suggestions include:
Optimizing model implementations
Enhancing preprocessing steps
Adding visualizations or additional evaluation metrics
